        ...
        <header class="text-gray-600 body-font">
            <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center relative">
                ...
                <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                    ...
                    <span class="ml-3 text-xl">MagU/X</span>
                </a>

                <nav
                    class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center">
                    <a href="javascript:void(0);" class="mr-5 hover:text-gray-900">Components</a>
                    <a href="javascript:void(0);" class="mr-5 hover:text-gray-900">Templates</a>
                    <a href="javascript:void(0);" class="mr-5 hover:text-gray-900">About Me</a>
                </nav>

                <button class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded-full text-base mt-4 md:mt-0">Order a Template
                </button>
                <span class="bg-gray-100 p-1 mx-2 rounded-full cursor-pointer">
                    <svg class="text-gray-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="true" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M20.354 15.354A9 9 0 0 1 8.646 3.646A9.003 9.003 0 0 0 12 21a9.003 9.003 0 0 0 8.354-5.646"/></svg>
                    <svg class="hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 1 1-8 0a4 4 0 0 1 8 0"/></svg>
                </span>
                

                <!-- Search -->
                <div class="w-[420px] absolute right-[50%] left-[50%] -translate-x-[50%]">

                    <!-- component -->
                    <div class='flex items-center justify-center'>
                        <div class="flex rounded-full bg-[#0d1829] px-2 py-0.5 w-full max-w-[600px]">
                            ...
                            <input
                                type="text"
                                class="w-full placeholder:text-slate-400 !text-white border-none focus:border-none focus:ring-0 rounded-xl flex bg-transparent pl-2 text-slate-600 text-sm outline-0 focus:outline-none"
                                placeholder="Search for a component name"
                            />
                            <button type="submit" class="relative p-0.5 rounded-full">
